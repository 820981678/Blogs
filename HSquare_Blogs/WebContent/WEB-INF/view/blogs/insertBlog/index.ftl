...
<body style="background: #eee;">
	<header style="width: 100%; height:40px; background: #555;">
	...
	<section style="width: 1080px; height: 1100px; margin-top: 10px; margin: 10px auto;">
		...
		<div style="width:100%; height:200px; background: white; margin-bottom:10px;">
			...
			<div style="width:100%; height:50px; line-height:50px; padding-left:10px;">
				标题:
				<input type="text" name="title" style="height:20px; width:600px;" />
			</div>
			<div style="width:100%; height:50px; line-height:50px; padding-left:10px;">
				标签:
				<#list btag as tag>
		...
		<!-- 文章内容 -->
		<div style="width:100%; height:650px; background: white; margin-bottom:10px;">
			<div style="width:100%; heigth:30px; line-height:30px; border-bottom: 2px solid #1ABC9C; ">
				<strong style="margin-left:10px;">文章内容</strong>
			</div>
