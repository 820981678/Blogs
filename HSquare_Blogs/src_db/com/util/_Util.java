...
public abstract class _Util {
     ...
     * 日志记录器.
     */
    protected static final Log logger = LogFactory.getLog("comon.utils");
    ...
    public static byte[] getBytes(String str, Charset charset) {
        ...
        try {
            ...
            if (logger.isWarnEnabled()) {
                logger.warn("_Util.getBytes() error, str:" + str + ", charset:" + charset + ", reason:" + e.getMessage());
            }
        }
        return bytes;
    }
    ...
    public static String getString(byte[] bytes, Charset charset) {
        ...
        try {
            ...
            if (logger.isWarnEnabled()) {
                logger.warn("_Util.getString() error, bytes:" + Arrays.toString(bytes) + ", charset:" + charset + ", reason:"
                        + e.getMessage());
            }
        }
        return str;
